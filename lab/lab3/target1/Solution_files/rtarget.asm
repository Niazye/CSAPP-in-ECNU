...
000000000040199a <getval_142>:                                        # 0x40199d
  40199a:	b8 fb 78 90 90       	mov    $0x909078fb,%eax               # nop 
  40199f:	c3                   	ret                                   # nop   
                                                                      # ret
00000000004019a0 <addval_273>:                                        # 0x4019a2      
  4019a0:	8d 87 48 89 c7 c3    	lea    -0x3c3876b8(%rdi),%eax         # movq %rax,%rdi
  4019a6:	c3                   	ret                                   # ret

00000000004019a7 <addval_219>:                                        # 0x4019ab
  4019a7:	8d 87 51 73 58 90    	lea    -0x6fa78caf(%rdi),%eax         # pop %rax
  4019ad:	c3                   	ret                                   # nop
                                                                      # ret
00000000004019ae <setval_237>:                                        # 0x4019b0
  4019ae:	c7 07 48 89 c7 c7    	movl   $0xc7c78948,(%rdi)             # movq %rax,%rdi
  4019b4:	c3                   	ret                                   # ?
                                                                      # ret
00000000004019b5 <setval_424>:                                        # 0x4019b9
  4019b5:	c7 07 54 c2 58 92    	movl   $0x9258c254,(%rdi)             # pop %rax
  4019bb:	c3                   	ret                                   # ?
                                                                      # ret
00000000004019bc <setval_470>:                                        # 0x4019bf 
  4019bc:	c7 07 63 48 8d c7    	movl   $0xc78d4863,(%rdi)             # ? ? ?
  4019c2:	c3                   	ret                                   # ret

00000000004019c3 <setval_426>:                                        # 0x4019c5
...
00000000004019db <getval_481>:                                        # 0x4019dd
  4019db:	b8 5c 89 c2 90       	mov    $0x90c2895c,%eax               
  4019e0:	c3                   	ret                                   # movl %eax,%edx
                                                                      # nop # ret
00000000004019e1 <setval_296>:
  4019e1:	c7 07 99 d1 90 90    	movl   $0x9090d199,(%rdi)
  4019e7:	c3                   	ret

00000000004019e8 <addval_113>:                                        # 0x4019ea
  4019e8:	8d 87 89 ce 78 c9    	lea    -0x36873177(%rdi),%eax         # movl %ecx,%esi
  4019ee:	c3                   	ret                                   # ? ?
                                                                      # ret
00000000004019ef <addval_490>:
  4019ef:	8d 87 8d d1 20 db    	lea    -0x24df2e73(%rdi),%eax         # andb %bl,%bl
  4019f5:	c3                   	ret

00000000004019f6 <getval_226>:
  4019f6:	b8 89 d1 48 c0       	mov    $0xc048d189,%eax               # movl %edx,%ecx
  4019fb:	c3                   	ret

00000000004019fc <setval_384>:
  4019fc:	c7 07 81 d1 84 c0    	movl   $0xc084d181,(%rdi)             # testb %al,%al
  401a02:	c3                   	ret

0000000000401a03 <addval_190>:                                        # 0x401a06
...
0000000000401a6e <setval_167>:                                        # 0x401a70
  401a6e:	c7 07 89 d1 91 c3    	movl   $0xc391d189,(%rdi)             # movl %edx,%ecx
  401a74:	c3                   	ret                                   # ? ret
